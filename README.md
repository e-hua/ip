...
1. After that, locate the `src/main/java/eclipse/Eclipse.java` file, right-click it, and choose
   `Run eclipse.Eclipse.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is
...
Delete the `build/` folder: `./gradlew clean`
